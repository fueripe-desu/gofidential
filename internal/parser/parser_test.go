...
func Test_Parse(t *testing.T) {
	testcases := []struct {
		...
		},
		{
			...
			expectedErr: newMissingAssignmentError(3, 4, "AGE"),
		},
		{
			name:        "should return an error if key is missing",
			fixtureName: "missing_key.env",
			expectedErr: newMissingKeyError(2, 1),
		},
		{
